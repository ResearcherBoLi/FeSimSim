...
/* Lower value of trtol to give smaller stepsize and more accuracy,
   ...
   may be overridden by 'set xtrtol=newval' */
	...
	printf("ngspice buildin total anal time count (sec) \n");
	printf("%f\n", ckt->CKTstat->STATtotAnalTime);
	printf("ngspice buildin tran run time count (sec) \n");
	printf("%f\n", ckt->CKTstat->STATtranTime );
	printf("ngspice buildin tran device load time count (sec) \n");
	printf("%f\n", ckt->CKTstat->STATtranLoadTime );
	printf("ngspice buildin tran LU time count (sec) \n");
	printf("%f\n", ckt->CKTstat->STATtranDecompTime );
	printf("ngspice buildin tran device LTE time (sec) \n");
	printf("%f\n", ckt->CKTstat->STATtranTruncTime );	
	printf("ngspice buildin tran Iteration count \n");
	printf("%ld\n", ckt->CKTstat->STATtranIter );
	printf("ngspice buildin tran time points() \n");
	printf("%ld\n", ckt->CKTstat->STATtimePts );

	

	
	duration = (double)(time_end -time_begin) / CLOCKS_PER_SEC;
	printf("my simulation time count by time.h \n");
